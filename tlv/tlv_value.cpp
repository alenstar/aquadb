...
TlvValue::TlvValue( const std::string &v )
    : _sval( nullptr )
    , _size( 0 )
    , _dtype( 0 )
    , _iscopy( 0 ) {
...
TlvValue::TlvValue( const char *v, size_t size )
    : _sval( nullptr )
    , _size( 0 )
    , _dtype( 0 )
    , _iscopy( 0 ) {
