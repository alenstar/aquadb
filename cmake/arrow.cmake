...
FILE(WRITE ${ARROW_SOURCES_DIR}/src/build.sh
        "cd cpp && cmake -DCMAKE_BUILD_TYPE=release -DARROW_JEMALLOC=OFF -DARROW_BUILD_SHARED=OFF -DARROW_IPC=ON -DARROW_WITH_LZ4=ON -DARROW_WITH_ZLIB=ON && make -j${NUM_OF_PROCESSOR}"
        )
